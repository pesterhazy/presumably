...
Think of how effective pair programming can be when working through a hard problem. The Linux virtual memory system allows you to double your RAM by making use of your hard drive capacity. Similarly, the pairing partner temporarily expands the programmer's working memory by allowing them access to part of their cognitive capacity. By writing down FIXMEs, you can achieve a similar effect. You temporarily extend your cognitive capacity by swapping to disk, i.e. by removing an idea from your working memory, with the intention to page it back in as needed, usually at the end of the session.[^better]
